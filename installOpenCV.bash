...
mkdir build
cd build
cmake -DENABLE_PRECOMPILED_HEADERS=OFF -DWITH_QT=OFF -DWITH_OPENGL=ON -DFORCE_VTK=ON -DWITH_TBB=ON -DWITH_GDAL=ON -DWITH_XINE=ON -DBUILD_EXAMPLES=OFF -DBUILD_DOCS=OFF  -G "Eclipse CDT4 - Unix Makefiles" -DOPENCV_EXTRA_MODULES_PATH=../../OpenCV_Contrib/modules ..
make -j4
sudo make install
sudo ldconfig
cd ../..
